...
const Marker = ({ text, onClick, ordine }) => (    
    ...
    >
        ...
        <div style={{ position: "absolute", bottom: "50%", width: "100%", height: "100%" }} ><svg fill="rgb(0, 141, 201)" stroke="white" strokeWidth="5px" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 90 125" xmlSpace="preserve" height="100%" width="100%">
