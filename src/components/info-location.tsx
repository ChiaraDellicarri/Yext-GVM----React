              ...
              <div className="container mt-6">
                  <div className="flex items-stretch flex-wrap box_cartina_orari">
                      ...
                      <div className="flex box_orari flex-col justify-between w-full md:w-2/5">
                          <div>
                              {regionePadreNome}
                              <a id="address" data-ya-track="LinkIndirizzo" className="via_struttura" href={`https://www.google.com/maps/dir/?api=1&destination=${defaultName} ${address.line1} ${address.city} ${address.region} ${address.postalCode}`} target="_blank">
                          ...
                          <div>
                              <a data-ya-track="CTAOttieniIndicazioni" className="button-blue" href={`https://www.google.com/maps/dir/?api=1&destination=${defaultName} ${address.line1} ${address.city} ${address.region} ${address.postalCode}`} target="_blank">
